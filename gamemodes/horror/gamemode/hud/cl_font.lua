...
addfont('QTG_hr_trName','Roboto Bk',25,800,false)
addfont('QTG_hr_trhp','Roboto Bk',20,800,false)
addfont('QTG_hr_HpArN','Roboto Bk',20,800,false)
addfont('QTG_hr_deathicon','csd',100,1000,false)
addfont('QTG_hr_MissionFailed','Roboto Bk',160,1000,false)
addfont('QTG_hr_MissionFailed2','Roboto Bk',30,1000,false)
